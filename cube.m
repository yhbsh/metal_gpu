...
- (void)render {
    ...
    _angleBuffer = [_gpu newBufferWithBytes:&elapsed length:sizeof(elapsed) options:MTLResourceStorageModeShared];
    ...
    [_renderEncoder setVertexBuffer:_angleBuffer     offset:0 atIndex:2];

    [_renderEncoder drawIndexedPrimitives:MTLPrimitiveTypeTriangle indexCount:sizeof(indices) / sizeof(indices[0]) indexType:MTLIndexTypeUInt16 indexBuffer:_indicesBuffer indexBufferOffset:0];
